<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"D:\phpStudy\PHPTutorial\WWW\wittree\public/../application/index\view\customer\saveaddress.html";i:1543828202;}*/ ?>
<!DOCTYPE html>
...
<div class="them">
    <input type="hidden" class="address_id" name="id" value="<?php echo $data['id']; ?>">
    <p><input type="text" class="sh-name" placeholder="收货人" value="<?php echo $data['link_name']; ?>"/></p>
    <p><input type="text" class="phone" placeholder="手机号码" value="<?php echo $data['phone']; ?>"/></p>
    <p><input type="text" class="area" placeholder="所在地区" value="<?php echo $data['area']; ?>"/></p>
    <p><input type="text" class="address" placeholder="详细地址" value="<?php echo $data['address']; ?>"/></p>
...
<script>
    $(function () {
        ...
        $("header .pull-right").bind("click", function () {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo url('customer/saveaddress'); ?>",
                data: {
                    id: $(".address_id").val(),
