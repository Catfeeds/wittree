<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"D:\phpStudy\PHPTutorial\WWW\wittree\public/../application/admin\view\lotto\lottoadd.html";i:1544076172;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>添加积分抽奖奖励</title>
        ...
        <div class="col-sm-10">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('lotto/lottoadd'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-7">
                                <input id="integral" class="form-control" name="integral">
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-3 control-label">中奖几率：</label>
                            <div class="input-group col-sm-7">
                                <input id="odds" class="form-control" name="odds">
                            </div>
                        </div>
                        <div class="form-group">
