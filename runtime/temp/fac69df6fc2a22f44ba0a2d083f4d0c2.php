<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:108:"D:\phpStudy\PHPTutorial\WWW\wittree\public/../application/admin\view\customeraddress\customeraddressadd.html";i:1542681825;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('customeraddress/customeraddressadd'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="linkman" type="text" class="form-control" name="linkman" required="" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
