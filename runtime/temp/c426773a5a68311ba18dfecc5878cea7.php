<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"D:\phpStudy\PHPTutorial\WWW\wittree\public/../application/admin\view\lesson\lessonedit.html";i:1543225763;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-10">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('lesson/lessonedit'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-7">
                                <input id="title" type="text" class="form-control" name="title" value="<?php echo $lessondata['title']; ?>" required="" aria-required="true">
                            </div>
                        </div>
                        <!--<div class="form-group">-->
                            ...
                            <!--<div class="input-group col-sm-4">-->
                                <!--<select class="form-control" name="chapter_id" required="" aria-required="true">-->
                                    ...
                                    <!--<option value="<?php echo $vo['id']; ?>" <?php if($vo['id'] == $lessondata['chapter_id']): ?>selected<?php endif; ?>><?php echo $vo['title']; ?></option>-->
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-7">
                                <input id="lesson" type="text" class="form-control" name="lesson" value="<?php echo $lessondata['lesson']; ?>" required="" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">所属课程：</label>
                            <div class="input-group col-sm-4">
                                <input id="" type="text" class="form-control" name="" disabled="disabled"  value="<?php echo $coursedata['title']; ?>" required="" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">缩略图：</label>
                            <input name="url" id="thumbnail" value="<?php echo $lessondata['url']; ?>" type="hidden"/>
                            <div class="form-inline">
                                ...
                                <div class="input-group col-sm-3">
                                    <div id="sm">
                                        <img src="<?php echo $lessondata['url']; ?>" width="40px" height="40px" alt="">
                                    </div>
                                </div>
                            </div>
