<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"D:\phpStudy\PHPTutorial\WWW\wittree\public/../application/admin\view\message\Messageedit.html";i:1544432624;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post"
                          action="<?php echo url('message/messageedit'); ?>">
                        <input type="hidden" name="id" value="<?php echo $message['id']; ?>">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">内容：</label>
                            <div class="input-group col-sm-7">
                                <textarea id="description" class="form-control"
                                          name="content"><?php echo $message['content']; ?></textarea>
                            </div>
                        </div>
                        <!--<div class="form-group">-->
