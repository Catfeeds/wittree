<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"D:\phpStudy\PHPTutorial\WWW\wittree\public/../application/admin\view\index.html";i:1544173325;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <span><img alt="image" class="img-circle" src="/static/index/images/face.jpg" style="width:64px;height:64px;"/></span>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer">
            <div class="pull-right">&copy; 2017-2019 <a href="#" target="_blank">####</a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
