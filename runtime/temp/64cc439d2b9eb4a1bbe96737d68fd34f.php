<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"D:\phpStudy\PHPTutorial\WWW\wittree\public/../application/index\view\login\register.html";i:1544422608;}*/ ?>
<!DOCTYPE html>
                ...
                success: function (data) {
                    if (data.code === -1) {
                        ...
                        setInterval(function () {
                            location.href = "<?php echo url('login/register'); ?>";
                        }, 2500);
                    } else {
                        $.toast(data.msg);
                        setInterval(function () {
