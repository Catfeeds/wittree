<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"D:\phpStudy\PHPTutorial\WWW\wittree\public/../application/admin\view\customer\authindex.html";i:1543905533;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>用户实名审核列表</title>
            ...
            <div class="example-wrap">
                <div class="example">
                    <table id="cusTable">
                        ...
                        <th data-field="real_name">实名名称</th>
                        <th data-field="id_number">身份证号</th>
                        <th data-field="face">头像</th>
                        <th data-field="sex">性别</th>
                        <th data-field="create_time">注册时间</th>
                        <th data-field="is_auth">状态</th>
