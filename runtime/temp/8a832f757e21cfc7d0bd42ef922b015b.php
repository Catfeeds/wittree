<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"D:\phpStudy\PHPTutorial\WWW\wittree\public/../application/admin\view\updown\uppoint.html";i:1542779991;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-10">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('updown/uppoint'); ?>">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">积分类别：</label>
                            <div class="input-group col-sm-6">
                                ...
                                <div class="radio i-checks col-sm-4">
                                    <label>
                                        <input type="radio" value="<?php echo $key; ?>" <?php if($key == 0): ?>checked<?php endif; ?> name="type"> <i></i> <?php echo $vo; ?></label>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="title" type="text" class="form-control" name="integral" value=""
                                       required="" aria-required="true">
                            </div>
                        </div>
