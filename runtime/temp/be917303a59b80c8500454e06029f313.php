<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"D:\phpStudy\PHPTutorial\WWW\wittree\public/../application/admin\view\lotto\lottoedit.html";i:1544076172;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>编辑积分抽奖奖励</title>
        ...
        <div class="col-sm-10">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('lotto/lottoedit'); ?>">
                        <input type="hidden" name="id" value="<?php echo $lotto['id']; ?>">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">标题：</label>
                            <div class="input-group col-sm-7">
                                <input id="title" type="text" class="form-control" name="title" value="<?php echo $lotto['title']; ?>" required="" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">积分：</label>
                            <div class="input-group col-sm-7">
                                <input id="integral" class="form-control" value="<?php echo $lotto['integral']; ?>" name="integral">
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-3 control-label">几率：</label>
                            <div class="input-group col-sm-7">
                                <input id="odds" class="form-control" name="odds" value="<?php echo $lotto['odds']; ?>" >
                            </div>
                        </div>
                        <div class="form-group">
