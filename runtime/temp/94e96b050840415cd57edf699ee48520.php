<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"D:\phpStudy\PHPTutorial\WWW\wittree\public/../application/admin\view\news\newsadd.html";i:1542963625;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-10">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('news/newsadd'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-7">
                                <input id="link_url" type="text" class="form-control" name="link_url" required="" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
