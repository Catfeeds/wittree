<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"D:\phpStudy\PHPTutorial\WWW\wittree\public/../application/admin\view\login.html";i:1542278527;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="signinpanel">
    <div class="row">
        <div class="col-sm-7">
            <div class="signin-info">
                ...
                <div class="m-b"></div>
                <h4>欢迎使用 <strong>智慧树系统后台</strong></h4>
                <ul class="m-b">
        ...
        <div class="col-sm-5">
            <form method="post" action="index.html">
                <p class="m-t-md" id="err_msg">登录到智慧树系统后台</p>
    ...
    <div class="signup-footer">
        <div class="pull-left">
            &copy; 2017-2019 All Rights Reserved. 智慧树
        </div>
    </div>
</div>
